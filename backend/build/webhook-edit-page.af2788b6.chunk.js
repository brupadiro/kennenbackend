...
const EventInput = ({ isDraftAndPublish }) => {
  ...
  return /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 1 }, /* @__PURE__ */ react.createElement(Field.FieldLabel, null, formatMessage({
    ...
    if (header === "app.utils.publish" || header === "app.utils.unpublish") {
      return /* @__PURE__ */ react.createElement(
        ...
        /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage(header))
      );
    }
    return /* @__PURE__ */ react.createElement("td", { key: header.id }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage(header)));
...
const Combobox_Combobox = (_a) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    options.map((key) => /* @__PURE__ */ react.createElement(Combobox.ComboboxOption, { value: key, key }, key))
  );
};
...
const HeadersInput = () => {
  ...
  })), /* @__PURE__ */ react.createElement(Box.Box, { padding: 8, background: "neutral100", hasRadius: true }, /* @__PURE__ */ react.createElement(
    dist.FieldArray,
    {
      ...
      render: ({ push, remove }) => {
        var _a;
        return /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 4 }, (_a = values.headers) == null ? void 0 : _a.map((header, i) => {
          var _a2, _b, _c, _d, _e, _f, _g, _h, _i, _j;
          return (
            // eslint-disable-next-line
            /* @__PURE__ */ react.createElement(react.Fragment, { key: i }, /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 6 }, /* @__PURE__ */ react.createElement(
              dist.Field,
              {
            ...
            )), /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 6 }, /* @__PURE__ */ react.createElement(Flex.Flex, { alignItems: "flex-end" }, /* @__PURE__ */ react.createElement(Box.Box, { style: { flex: 1 } }, /* @__PURE__ */ react.createElement(
              dist.Field,
              {
        ...
        }), /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 12 }, /* @__PURE__ */ react.createElement(
...
const Status = ({ isPending, statusCode }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  if (isPending) {
    return /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, spacing: 2, style: { alignItems: "center" } }, /* @__PURE__ */ react.createElement(Icon, { as: (Loader_default()) }), /* @__PURE__ */ react.createElement(Typography.Typography, null, formatMessage({ id: "Settings.webhooks.trigger.pending", defaultMessage: "pending" })));
  }
  if (statusCode >= 200 && statusCode < 300) {
    return /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, spacing: 2, style: { alignItems: "center" } }, /* @__PURE__ */ react.createElement(Icon, { as: (Check_default()), color: "success700" }), /* @__PURE__ */ react.createElement(Typography.Typography, null, formatMessage({ id: "Settings.webhooks.trigger.success", defaultMessage: "success" })));
  }
  if (statusCode >= 300) {
    return /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, spacing: 2, style: { alignItems: "center" } }, /* @__PURE__ */ react.createElement(Icon, { as: (Cross_default()), color: "danger700" }), /* @__PURE__ */ react.createElement(Typography.Typography, null, formatMessage({ id: "Settings.error", defaultMessage: "error" }), " ", statusCode));
  }
  return null;
};
Status.propTypes = {
...
const Message = ({ statusCode, message }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  if (statusCode >= 200 && statusCode < 300) {
    return /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "flex-end" }, /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "neutral600", ellipsis: true }, formatMessage({
      id: "Settings.webhooks.trigger.success.label",
      defaultMessage: "Trigger succeeded"
    })));
  }
  if (statusCode >= 300) {
    return /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "flex-end" }, /* @__PURE__ */ react.createElement(Flex.Flex, { maxWidth: (0,build.pxToRem)(250), justifyContent: "flex-end", title: message }, /* @__PURE__ */ react.createElement(Typography.Typography, { ellipsis: true, textColor: "neutral600" }, message)));
  }
  return null;
};
Message.propTypes = {
...
const CancelButton = ({ onCancel }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "flex-end" }, /* @__PURE__ */ react.createElement("button", { onClick: onCancel, type: "button" }, /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, spacing: 2, style: { alignItems: "center" } }, /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "neutral400" }, formatMessage({ id: "Settings.webhooks.trigger.cancel", defaultMessage: "cancel" })), /* @__PURE__ */ react.createElement(Icon, { as: (Cross_default()), color: "neutral400" }))));
};
...
const TriggerContainer = ({ isPending, onCancel, response }) => {
  ...
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(Box.Box, { background: "neutral0", padding: 5, shadow: "filterShadow", hasRadius: true }, /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 4, style: { alignItems: "center" } }, /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 3 }, /* @__PURE__ */ react.createElement(Typography.Typography, null, formatMessage({
    id: "Settings.webhooks.trigger.test",
    defaultMessage: "Test-trigger"
  }))), /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 3 }, /* @__PURE__ */ react.createElement(Status, { isPending, statusCode })), /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 6 }, !isPending ? /* @__PURE__ */ react.createElement(Message, { statusCode, message }) : /* @__PURE__ */ react.createElement(CancelButton, { onCancel }))));
};
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    ({ handleSubmit: handleSubmit2, errors }) => /* @__PURE__ */ react.createElement(build.Form, { noValidate: true }, /* @__PURE__ */ react.createElement(
      Layout.HeaderLayout,
      {
        ...
        ), /* @__PURE__ */ react.createElement(Button.Button, { startIcon: /* @__PURE__ */ react.createElement((Check_default()), null), onClick: handleSubmit2, type: "submit", size: "L" }, formatMessage({
          id: "global.save",
          defaultMessage: "Save"
        }))),
        ...
        navigationAction: /* @__PURE__ */ react.createElement(build.Link, { startIcon: /* @__PURE__ */ react.createElement((ArrowLeft_default()), null), to: "/settings/webhooks" }, formatMessage({
          id: "global.back",
          defaultMessage: "Back"
        }))
      }
    ), /* @__PURE__ */ react.createElement(Layout.ContentLayout, null, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 4 }, showTriggerResponse && /* @__PURE__ */ react.createElement("div", { className: "trigger-wrapper" }, /* @__PURE__ */ react.createElement(
    ...
    )), /* @__PURE__ */ react.createElement(Box.Box, { background: "neutral0", padding: 8, shadow: "filterShadow", hasRadius: true }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 6 }, /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 6 }, /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 6 }, /* @__PURE__ */ react.createElement(
      dist.Field,
      {
        as: TextInput.TextInput,
        name: "name",
...
const EditView = () => {
  ...
  return /* @__PURE__ */ react.createElement(Main.Main, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, { name: "Webhooks" }), /* @__PURE__ */ react.createElement(
