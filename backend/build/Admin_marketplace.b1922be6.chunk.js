...
const EmptyNpmPackageGrid = () => {
  return /* @__PURE__ */ react.createElement(Layout.GridLayout, null, Array(12).fill(null).map((_, idx) => /* @__PURE__ */ react.createElement(
    EmptyPluginCard,
    {
...
const EmptyNpmPackageSearch = ({ content }) => {
  return /* @__PURE__ */ react.createElement(Box.Box, { position: "relative" }, /* @__PURE__ */ react.createElement(EmptyNpmPackageGrid, null), /* @__PURE__ */ react.createElement(Box.Box, { position: "absolute", top: 11, width: "100%" }, /* @__PURE__ */ react.createElement(Flex.Flex, { alignItems: "center", justifyContent: "center", direction: "column" }, /* @__PURE__ */ react.createElement(Icon.Icon, { as: (EmptyDocuments_default()), color: "", width: "160px", height: "88px" }), /* @__PURE__ */ react.createElement(Box.Box, { paddingTop: 6 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "p", textColor: "neutral600" }, content)))));
};
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(
      build.ContentBox,
      {
        ...
        endAction: /* @__PURE__ */ react.createElement(Icon.Icon, { as: (ExternalLink_default()), color: "neutral600", width: 3, height: 3, marginLeft: 2 })
      }
    )
  );
};
...
const TooltipButton = ({ description, installMessage, disabled, handleCopy, pluginName }) => /* @__PURE__ */ react.createElement(Tooltip.Tooltip, { "data-testid": `tooltip-${pluginName}`, description }, /* @__PURE__ */ react.createElement(Box.Box, null, /* @__PURE__ */ react.createElement(
  Button.Button,
  {
    size: "S",
...
const CardButton = ({ strapiPeerDepVersion, strapiAppVersion, handleCopy, pluginName }) => {
  ...
  return /* @__PURE__ */ react.createElement(Button.Button, { size: "S", startIcon: /* @__PURE__ */ react.createElement((Duplicate_default()), null), variant: "secondary", onClick: handleCopy }, installMessage);
};
...
const InstallPluginButton = ({
  ...
  if (isInstalled) {
    return /* @__PURE__ */ react.createElement(Box.Box, { paddingLeft: 4 }, /* @__PURE__ */ react.createElement(Icon.Icon, { as: (Check_default()), marginRight: 2, width: 12, height: 12, color: "success600" }), /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "omega", textColor: "success600", fontWeight: "bold" }, formatMessage({
...
const PackageStats = ({ githubStars, npmDownloads, npmPackageType }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, spacing: 1 }, !!githubStars && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Icon.Icon, { as: (Github_default()), height: (0,build.pxToRem)(12), width: (0,build.pxToRem)(12), "aria-hidden": true }), /* @__PURE__ */ react.createElement(Icon.Icon, { as: (Star_default()), height: (0,build.pxToRem)(12), width: (0,build.pxToRem)(12), color: "warning500", "aria-hidden": true }), /* @__PURE__ */ react.createElement(
    "p",
    {
    ...
    /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "pi", textColor: "neutral800", lineHeight: 16 }, githubStars)
  ), /* @__PURE__ */ react.createElement(VerticalDivider, { unsetMargin: false, background: "neutral200" })), /* @__PURE__ */ react.createElement(Icon.Icon, { as: (Download_default()), height: (0,build.pxToRem)(12), width: (0,build.pxToRem)(12), "aria-hidden": true }), /* @__PURE__ */ react.createElement(
    "p",
    {
      "aria-label": formatMessage(
        {
    ...
    /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "pi", textColor: "neutral800", lineHeight: 16 }, npmDownloads)
  ));
};
...
const NpmPackageCard = ({
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Box.Box, null, /* @__PURE__ */ react.createElement(Flex.Flex, { direction: "row", justifyContent: "space-between", alignItems: "flex-start" }, /* @__PURE__ */ react.createElement(
      Box.Box,
      {
        as: "img",
    ...
    )), /* @__PURE__ */ react.createElement(Box.Box, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(Typography.Typography, { as: "h3", variant: "delta" }, /* @__PURE__ */ react.createElement(Flex.Flex, { alignItems: "center" }, attributes.name, attributes.validated && !attributes.madeByStrapi && /* @__PURE__ */ react.createElement(
      Tooltip.Tooltip,
      {
        description: formatMessage({
      ...
      /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(Icon.Icon, { as: (CheckCircle_default()), marginLeft: 2, color: "success600" }))
    ), attributes.madeByStrapi && /* @__PURE__ */ react.createElement(Tooltip.Tooltip, { description: madeByStrapiMessage }, /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(
      Box.Box,
      {
        as: "img",
    ...
    )))))), /* @__PURE__ */ react.createElement(Box.Box, { paddingTop: 2 }, /* @__PURE__ */ react.createElement(EllipsisText, { as: "p", variant: "omega", textColor: "neutral600" }, attributes.description))),
    /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, spacing: 2, style: { alignSelf: "flex-end" }, paddingTop: 6 }, /* @__PURE__ */ react.createElement(
      LinkButton.LinkButton,
      {
        size: "S",
        href: npmPackageHref,
...
const NpmPackagesGrid = ({
  ...
  return /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 4 }, npmPackages.map((npmPackage) => /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 4, s: 6, xs: 12, style: { height: "100%" }, key: npmPackage.id }, /* @__PURE__ */ react.createElement(
...
const SortSelect = ({ sortQuery, handleSelectChange }) => {
  ...
  return /* @__PURE__ */ react.createElement(SelectWrapper, null, /* @__PURE__ */ react.createElement(
    ...
    Object.entries(sortTypes).map(([sortName, messages]) => {
      return /* @__PURE__ */ react.createElement(Select.Option, { key: sortName, value: sortName }, formatMessage(messages.option));
    })
  ));
};
...
const FilterSelect = ({ message, value, onChange, possibleFilters, onClear, customizeContent }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    Object.entries(possibleFilters).map(([filterName, count]) => {
      return /* @__PURE__ */ react.createElement(Select.Option, { key: filterName, value: filterName }, computeFilterMessage(filterName, count));
    })
  );
};
...
const FiltersPopover = ({
  ...
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(Popover.Popover, { source, padding: 3, spacing: 4, onBlur: () => {
  } }, /* @__PURE__ */ react.createElement(FocusTrap.FocusTrap, { onEscape: onToggle }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 1 }, /* @__PURE__ */ react.createElement(Box.Box, null, /* @__PURE__ */ react.createElement(
  ...
  )), npmPackageType === "plugin" && /* @__PURE__ */ react.createElement(Box.Box, null, /* @__PURE__ */ react.createElement(
    NpmPackagesFilters_FilterSelect,
    {
      message: formatMessage({
...
const FilterTag = ({ name, handleRemove }) => {
  return /* @__PURE__ */ react.createElement(Box.Box, { padding: 1 }, /* @__PURE__ */ react.createElement(Tag.Tag, { icon: /* @__PURE__ */ react.createElement((Cross_default()), null), onClick: handleRemove }, name));
};
...
const MarketPlacePage = () => {
  ...
  if (!isOnline) {
    return /* @__PURE__ */ react.createElement(Layout.Layout, null, /* @__PURE__ */ react.createElement(Main.Main, null, /* @__PURE__ */ react.createElement(components_PageHeader, { isOnline }), /* @__PURE__ */ react.createElement(
      Flex.Flex,
      {
        width: "100%",
        direction: "column",
      ...
      /* @__PURE__ */ react.createElement(Box.Box, { paddingBottom: 2 }, /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "neutral700", variant: "alpha" }, formatMessage({
        id: "admin.pages.MarketPlacePage.offline.title",
        defaultMessage: "You are offline"
      }))),
      /* @__PURE__ */ react.createElement(Box.Box, { paddingBottom: 6 }, /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "neutral700", variant: "epsilon" }, formatMessage({
  ...
  if (hasFailed) {
    return /* @__PURE__ */ react.createElement(Layout.Layout, null, /* @__PURE__ */ react.createElement(Layout.ContentLayout, null, /* @__PURE__ */ react.createElement(Box.Box, { paddingTop: 8 }, /* @__PURE__ */ react.createElement(build.AnErrorOccurred, null))));
  }
  if (isLoading) {
    return /* @__PURE__ */ react.createElement(Layout.Layout, null, /* @__PURE__ */ react.createElement(Main.Main, { "aria-busy": true }, /* @__PURE__ */ react.createElement(build.LoadingIndicatorPage, null)));
  }
  ...
  return /* @__PURE__ */ react.createElement(Layout.Layout, null, /* @__PURE__ */ react.createElement(Main.Main, null, /* @__PURE__ */ react.createElement(
    Helmet.Helmet,
    {
      title: formatMessage({
  ...
  ), /* @__PURE__ */ react.createElement(components_PageHeader, { isOnline, npmPackageType }), /* @__PURE__ */ react.createElement(Layout.ContentLayout, null, /* @__PURE__ */ react.createElement(Box.Box, { width: "25%", paddingBottom: 4 }, /* @__PURE__ */ react.createElement(
    Searchbar.Searchbar,
    {
      name: "searchbar",
    ...
    /* @__PURE__ */ react.createElement(Box.Box, { paddingBottom: 4 }, /* @__PURE__ */ react.createElement(Tabs.Tabs, null, /* @__PURE__ */ react.createElement(Tabs.Tab, null, formatMessage({
    ...
    /* @__PURE__ */ react.createElement(Flex.Flex, { paddingBottom: 4, gap: 2 }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Tabs.TabPanels, null, /* @__PURE__ */ react.createElement(Tabs.TabPanel, null, searchQuery.length > 0 && !pluginSearchResults.length ? /* @__PURE__ */ react.createElement(components_EmptyNpmPackageSearch, { content: emptySearchMessage }) : /* @__PURE__ */ react.createElement(
    ...
    )), /* @__PURE__ */ react.createElement(Tabs.TabPanel, null, searchQuery.length > 0 && !providerSearchResults.length ? /* @__PURE__ */ react.createElement(components_EmptyNpmPackageSearch, { content: emptySearchMessage }) : /* @__PURE__ */ react.createElement(
      components_NpmPackagesGrid,
      {
  ...
  ), /* @__PURE__ */ react.createElement(Box.Box, { paddingTop: 7 }, /* @__PURE__ */ react.createElement(components_MissingPluginBanner, null)))));
};
