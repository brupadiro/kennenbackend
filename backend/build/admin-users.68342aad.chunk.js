...
const TableRows = ({
  ...
  return /* @__PURE__ */ react.createElement(Table.Tbody, null, rows.map((data) => {
    ...
    return /* @__PURE__ */ react.createElement(
      ...
      withMainAction && /* @__PURE__ */ react.createElement(Table.Td, __spreadValues({}, build.stopPropagation), /* @__PURE__ */ react.createElement(
      ...
      headers.map((_a) => {
        ...
        return /* @__PURE__ */ react.createElement(Table.Td, { key }, typeof cellFormatter === "function" ? cellFormatter(data, __spreadValues({ key, name, formatMessage }, rest)) : /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "neutral800" }, data[name] || "-"));
      }),
      withBulkActions && /* @__PURE__ */ react.createElement(Table.Td, null, /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "end" }, /* @__PURE__ */ react.createElement(
      ...
      ), canDelete && /* @__PURE__ */ react.createElement(Box.Box, __spreadValues({ paddingLeft: 1 }, build.stopPropagation), /* @__PURE__ */ react.createElement(
        IconButton.IconButton,
        {
...
const PaginationFooter = ({ pagination }) => {
  return /* @__PURE__ */ react.createElement(Box.Box, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(Flex.Flex, { alignItems: "flex-end", justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(build.PageSizeURLQuery, null), /* @__PURE__ */ react.createElement(build.PaginationURLQuery, { pagination })));
};
...
const tableHeaders = [
  ...
  },
  {
    ...
    cellFormatter({ roles }, { formatMessage }) {
      return /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "neutral800" }, roles.map(
        (role) => formatMessage({
  ...
  },
  {
    ...
    cellFormatter({ isActive }, { formatMessage }) {
      return /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(build.Status, { isActive, variant: isActive ? "success" : "danger" }), /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "neutral800" }, formatMessage({
...
const ListPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Main.Main, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, { name: "Users" }), /* @__PURE__ */ react.createElement(
    Layout.HeaderLayout,
    {
  ...
  ), /* @__PURE__ */ react.createElement(Layout.ContentLayout, { canRead }, !canRead && /* @__PURE__ */ react.createElement(build.NoPermissions, null), status === "error" && /* @__PURE__ */ react.createElement("div", null, "TODO: An error occurred"), canRead && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
    build.DynamicTable,
    {
      contentType: "Users",
      isLoading,
...
const MagicLinkWrapper = ({ children, target }) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
    _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_2__.ContentBox,
    {
      endAction: /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_copy_to_clipboard__WEBPACK_IMPORTED_MODULE_4__.CopyToClipboard, { onCopy: handleCopy, text: target }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_IconButton__WEBPACK_IMPORTED_MODULE_1__.IconButton, { label: copyLabel, noBorder: true, icon: /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement((_strapi_icons_Duplicate__WEBPACK_IMPORTED_MODULE_3___default()), null) })),
      title: target,
      titleEllipsis: true,
      subtitle: children,
...
const SelectRoles = ({ disabled, error, onChange, value }) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
    _strapi_design_system_Select__WEBPACK_IMPORTED_MODULE_1__.Select,
    {
      id: "roles",
      disabled,
      error: errorMessage,
    ...
    (data || []).map((role) => {
      return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Select__WEBPACK_IMPORTED_MODULE_1__.Option, { key: role.id, value: role.id }, formatMessage({
        id: `global.${role.code}`,
        defaultMessage: role.name
      }));
    })
