...
const DeleteButton = ({ tokenName, onClickDelete }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box.Box, __spreadValues({ paddingLeft: 1 }, build.stopPropagation), /* @__PURE__ */ react.createElement(
...
const UpdateButton = ({ tokenName, tokenId }) => {
  return /* @__PURE__ */ react.createElement(DynamicTable_DefaultButton, { tokenName, tokenId }, /* @__PURE__ */ react.createElement((Pencil_default()), null));
};
...
const ReadButton = ({ tokenName, tokenId }) => {
  return /* @__PURE__ */ react.createElement(DynamicTable_DefaultButton, { tokenName, tokenId, buttonType: "read" }, /* @__PURE__ */ react.createElement((Eye_default()), null));
};
...
const TableRows = ({ canDelete, canUpdate, canRead, onClickDelete, withBulkActions, rows }) => {
  ...
  return /* @__PURE__ */ react.createElement(Table.Tbody, null, apiTokens.map((apiToken) => {
    return /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(Table.Td, null, /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "neutral800", fontWeight: "bold" }, apiToken.name)),
      /* @__PURE__ */ react.createElement(Table.Td, { maxWidth: (0,build.pxToRem)(250) }, /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "neutral800", ellipsis: true }, apiToken.description)),
      /* @__PURE__ */ react.createElement(Table.Td, null, /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "neutral800" }, /* @__PURE__ */ react.createElement(build.RelativeTime, { timestamp: new Date(apiToken.createdAt) }))),
      /* @__PURE__ */ react.createElement(Table.Td, null, apiToken.lastUsedAt && /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "neutral800" }, /* @__PURE__ */ react.createElement(build.RelativeTime, { timestamp: new Date(apiToken.lastUsedAt) }))),
      withBulkActions && /* @__PURE__ */ react.createElement(Table.Td, null, /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "end" }, canUpdate && /* @__PURE__ */ react.createElement(DynamicTable_UpdateButton, { tokenName: apiToken.name, tokenId: apiToken.id }), !canUpdate && canRead && /* @__PURE__ */ react.createElement(DynamicTable_ReadButton, { tokenName: apiToken.name, tokenId: apiToken.id }), canDelete && /* @__PURE__ */ react.createElement(
...
const ApiTokenListView = () => {
  ...
  return /* @__PURE__ */ react.createElement(Main.Main, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, { name: "API Tokens" }), /* @__PURE__ */ react.createElement(
    Layout.HeaderLayout,
    {
  ...
  ), /* @__PURE__ */ react.createElement(Layout.ContentLayout, null, !canRead && /* @__PURE__ */ react.createElement(build.NoPermissions, null), shouldDisplayDynamicTable && /* @__PURE__ */ react.createElement(
    build.DynamicTable,
    {
      headers,
    ...
    build.NoContent,
    {
      ...
      action: /* @__PURE__ */ react.createElement(Button.Button, { variant: "secondary", startIcon: /* @__PURE__ */ react.createElement((Plus_default()), null) }, formatMessage({
