...
const TableBody = ({ sortedRoles, canDelete, permissions, setRoleToDelete, onDelete }) => {
  ...
  return /* @__PURE__ */ react.createElement(Table.Tbody, null, sortedRoles == null ? void 0 : sortedRoles.map((role) => /* @__PURE__ */ react.createElement(Table.Tr, __spreadValues({ key: role.name }, (0,build.onRowClick)({ fn: () => handleClickEdit(role.id) })), /* @__PURE__ */ react.createElement(Table.Td, { width: "20%" }, /* @__PURE__ */ react.createElement(Typography.Typography, null, role.name)), /* @__PURE__ */ react.createElement(Table.Td, { width: "50%" }, /* @__PURE__ */ react.createElement(Typography.Typography, null, role.description)), /* @__PURE__ */ react.createElement(Table.Td, { width: "30%" }, /* @__PURE__ */ react.createElement(Typography.Typography, null, `${role.nb_users} ${formatMessage({
    id: "global.users",
    defaultMessage: "users"
  }).toLowerCase()}`)), /* @__PURE__ */ react.createElement(Table.Td, null, /* @__PURE__ */ react.createElement(Flex.Flex, __spreadValues({ justifyContent: "end" }, build.stopPropagation), /* @__PURE__ */ react.createElement(build.CheckPermissions, { permissions: permissions.updateRole }, /* @__PURE__ */ react.createElement(
...
const RoleListPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Layout.Layout, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, { name: pageTitle }), /* @__PURE__ */ react.createElement(Main.Main, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(
    Layout.HeaderLayout,
    {
      title: formatMessage({
        id: "global.roles",
      ...
      primaryAction: /* @__PURE__ */ react.createElement(build.CheckPermissions, { permissions: permissions/* default.createRole */.Z.createRole }, /* @__PURE__ */ react.createElement(Button.Button, { onClick: handleNewRoleClick, startIcon: /* @__PURE__ */ react.createElement((Plus_default()), null), size: "S" }, formatMessage({
...
function BoundRoute({ route }) {
  ...
  return /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 2 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "h3" }, formatMessage({
    id: "users-permissions.BoundRoute.title",
    defaultMessage: "Bound route to"
  }), "\xA0", /* @__PURE__ */ react.createElement("span", null, controller), /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", textColor: "primary600" }, ".", action)), /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, hasRadius: true, background: "neutral0", borderColor: "neutral200", spacing: 0 }, /* @__PURE__ */ react.createElement(MethodBox, { background: colors.background, borderColor: colors.border, padding: 2 }, /* @__PURE__ */ react.createElement(Typography.Typography, { fontWeight: "bold", textColor: colors.text }, method)), /* @__PURE__ */ react.createElement(Box.Box, { paddingLeft: 2, paddingRight: 2 }, map_default()(formattedRoute, (value) => /* @__PURE__ */ react.createElement(Typography.Typography, { key: value, textColor: value.includes(":") ? "neutral600" : "neutral900" }, "/", value)))));
}
...
const Policies = () => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    selectedAction ? /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 2 }, displayedRoutes.map((route, key) => (
      // eslint-disable-next-line react/no-array-index-key
      /* @__PURE__ */ react.createElement(components_BoundRoute, { key, route })
    ))) : /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 2 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "h3" }, formatMessage({
      id: "users-permissions.Policies.header.title",
      defaultMessage: "Advanced settings"
    })), /* @__PURE__ */ react.createElement(Typography.Typography, { as: "p", textColor: "neutral600" }, formatMessage({
...
const SubCategory = ({ subCategory }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box.Box, null, /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "space-between", alignItems: "center" }, /* @__PURE__ */ react.createElement(Box.Box, { paddingRight: 4 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, subCategory.label)), /* @__PURE__ */ react.createElement(Border, null), /* @__PURE__ */ react.createElement(Box.Box, { paddingLeft: 4 }, /* @__PURE__ */ react.createElement(
    Checkbox.Checkbox,
    {
  ...
  ))), /* @__PURE__ */ react.createElement(Flex.Flex, { paddingTop: 6, paddingBottom: 6 }, /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 2, style: { flex: 1 } }, subCategory.actions.map((action) => {
    const name = `${action.name}.enabled`;
    return /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 6, key: action.name }, /* @__PURE__ */ react.createElement(PermissionRow_CheckboxWrapper, { isActive: isActionSelected(action.name), padding: 2, hasRadius: true }, /* @__PURE__ */ react.createElement(
      Checkbox.Checkbox,
      {
...
const PermissionRow = ({ name, permissions }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box.Box, { padding: 6 }, subCategories.map((subCategory) => /* @__PURE__ */ react.createElement(PermissionRow_SubCategory, { key: subCategory.name, subCategory })));
};
...
const Permissions = () => {
  ...
  return /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 1 }, collapses.map((collapse, index) => /* @__PURE__ */ react.createElement(
    Accordion.Accordion,
    {
    ...
    /* @__PURE__ */ react.createElement(Accordion.AccordionContent, null, /* @__PURE__ */ react.createElement(Box.Box, null, /* @__PURE__ */ react.createElement(Permissions_PermissionRow, { permissions: modifiedData[collapse.name], name: collapse.name })))
  )));
};
...
const UsersPermissions_UsersPermissions = (0,react.forwardRef)(({ permissions, routes }, ref) => {
  ...
  return /* @__PURE__ */ react.createElement(UsersPermissionsProvider, { value: providerValue }, /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 0, shadow: "filterShadow", hasRadius: true, background: "neutral0" }, /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 7, paddingTop: 6, paddingBottom: 6, paddingLeft: 7, paddingRight: 7 }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 6 }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 2 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "h2" }, formatMessage({
  ...
  return /* @__PURE__ */ react.createElement(Main.Main, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, { name: "Roles" }), /* @__PURE__ */ react.createElement(
    ...
    ({ handleSubmit, values, handleChange, errors }) => /* @__PURE__ */ react.createElement(build.Form, { noValidate: true, onSubmit: handleSubmit }, /* @__PURE__ */ react.createElement(
      Layout.HeaderLayout,
      {
        ...
        navigationAction: /* @__PURE__ */ react.createElement(build.Link, { startIcon: /* @__PURE__ */ react.createElement((ArrowLeft_default()), null), to: "/settings/users-permissions/roles" }, formatMessage({
          id: "global.back",
          defaultMessage: "Back"
        }))
      }
    ), /* @__PURE__ */ react.createElement(Layout.ContentLayout, null, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 7 }, /* @__PURE__ */ react.createElement(
      Box.Box,
      {
        background: "neutral0",
        hasRadius: true,
...
const CreatePage_EditPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Main.Main, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, { name: "Roles" }), /* @__PURE__ */ react.createElement(
    ...
    ({ handleSubmit, values, handleChange, errors }) => /* @__PURE__ */ react.createElement(build.Form, { noValidate: true, onSubmit: handleSubmit }, /* @__PURE__ */ react.createElement(
      Layout.HeaderLayout,
      {
        primaryAction: !isLoadingPlugins && /* @__PURE__ */ react.createElement(Button.Button, { type: "submit", loading: isSubmitting, startIcon: /* @__PURE__ */ react.createElement((Check_default()), null) }, formatMessage({
          id: "global.save",
          defaultMessage: "Save"
        })),
        title: formatMessage({
