...
const reducer = (state, action) => (
  ...
  (0,immer_cjs_production_min["default"])(state, (drafState) => {
    switch (action.type) {
      case "CANCEL_CHANGES": {
...
const SettingsPage = () => {
  ...
  ), /* @__PURE__ */ react.createElement(Layout.ContentLayout, null, isLoading ? /* @__PURE__ */ react.createElement(build.LoadingIndicatorPage, null) : /* @__PURE__ */ react.createElement(Layout.Layout, null, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 12 }, /* @__PURE__ */ react.createElement(Box.Box, { background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 4 }, /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "h2" }, formatMessage({
