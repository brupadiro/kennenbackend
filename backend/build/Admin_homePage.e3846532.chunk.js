...
const StepHomepage = ({ type, title, number, content, hasLine }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box.Box, null, /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(Box.Box, { minWidth: (0,build.pxToRem)(30), marginRight: 5 }, /* @__PURE__ */ react.createElement(StepNumber/* default */.Z, { type, number })), /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "h3" }, formatMessage(title))), /* @__PURE__ */ react.createElement(Flex.Flex, { alignItems: "flex-start" }, /* @__PURE__ */ react.createElement(
    Flex.Flex,
    {
  ...
  ), /* @__PURE__ */ react.createElement(Box.Box, { marginTop: 2 }, type === constants/* IS_ACTIVE */.lW && content)));
};
...
const StepperHomepage = ({ sections, currentSectionKey }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box.Box, null, sections.map((section, index) => /* @__PURE__ */ react.createElement(
    Step,
    {
      key: section.key,
      title: section.title,
...
const GuidedTourHomepage = () => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 6 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "beta", as: "h2" }, formatMessage({
      id: "app.components.GuidedTour.title",
      defaultMessage: "3 steps to get started"
    })), /* @__PURE__ */ react.createElement(Stepper, { sections, currentSectionKey: activeSection })),
    /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "flex-end" }, /* @__PURE__ */ react.createElement(Button.Button, { variant: "tertiary", onClick: handleSkip }, formatMessage({ id: "app.components.GuidedTour.skip", defaultMessage: "Skip the tour" })))
  );
};
...
const socialLinks = [
  {
    ...
    icon: /* @__PURE__ */ react.createElement((Github_default()), { fill: "#7289DA" }),
    alt: "github"
  },
  {
    name: "Discord",
...
const SocialLinks = () => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Box.Box, { paddingBottom: 7 }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 5 }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 3 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "h2", id: "join-the-community" }, formatMessage({
      id: "app.components.HomePage.community",
      defaultMessage: "Join the community"
    })), /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "neutral600" }, formatMessage({
    ...
    }))), /* @__PURE__ */ react.createElement(Link.Link, { href: "https://feedback.strapi.io/", isExternal: true, endIcon: /* @__PURE__ */ react.createElement((ExternalLink_default()), null) }, formatMessage({
    ...
    /* @__PURE__ */ react.createElement(GridGap, null, socialLinks.map((socialLink) => {
      return /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 6, s: 12, key: socialLink.name }, /* @__PURE__ */ react.createElement(
        LinkCustom,
        {
          size: "L",
...
const HomeHeader = ({ hasCreatedContentType, onCreateCT }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement("div", null, /* @__PURE__ */ react.createElement(Box.Box, { paddingLeft: 6, paddingBottom: 10 }, /* @__PURE__ */ react.createElement(StackCustom, { spacing: 5 }, /* @__PURE__ */ react.createElement(Typography.Typography, { as: "h1", variant: "alpha" }, hasCreatedContentType ? formatMessage({
  ...
  })), hasCreatedContentType ? /* @__PURE__ */ react.createElement(Link.Link, { isExternal: true, href: "https://strapi.io/blog" }, formatMessage({
    id: "app.components.HomePage.button.blog",
    defaultMessage: "See more on the blog"
  })) : /* @__PURE__ */ react.createElement(Button.Button, { size: "L", onClick: onCreateCT, endIcon: /* @__PURE__ */ react.createElement((ArrowRight_default()), null) }, formatMessage({
...
const ContentBlocks = () => {
  ...
  return /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 5 }, /* @__PURE__ */ react.createElement(
    BlockLink,
    {
...
const HomePage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Layout.Layout, null, /* @__PURE__ */ react.createElement(react_intl.FormattedMessage, { id: "HomePage.helmet.title", defaultMessage: "Homepage" }, (title) => /* @__PURE__ */ react.createElement(Helmet.Helmet, { title: title[0] })), /* @__PURE__ */ react.createElement(Main.Main, null, /* @__PURE__ */ react.createElement(LogoContainer, null, /* @__PURE__ */ react.createElement("img", { alt: "", "aria-hidden": true, src: corner_ornament_namespaceObject })), /* @__PURE__ */ react.createElement(Box.Box, { padding: 10 }, /* @__PURE__ */ react.createElement(Grid.Grid, null, /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 8, s: 12 }, /* @__PURE__ */ react.createElement(
    HomePage_HomeHeader,
    {
      onCreateCT: handleClick,
      hasCreatedContentType: hasAlreadyCreatedContentTypes
    }
  ))), /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 6 }, /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 8, s: 12 }, showGuidedTour ? /* @__PURE__ */ react.createElement(Homepage, null) : /* @__PURE__ */ react.createElement(HomePage_ContentBlocks, null)), /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 4, s: 12 }, /* @__PURE__ */ react.createElement(HomePage_SocialLinks, null))))));
};
