...
const SingleSignOn = () => {
  ...
  return /* @__PURE__ */ react.createElement(Layout.Layout, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, { name: "SSO" }), /* @__PURE__ */ react.createElement(Main.Main, { tabIndex: -1 }, /* @__PURE__ */ react.createElement(
    "form",
    {
      onSubmit: (e) => {
    ...
    /* @__PURE__ */ react.createElement(Layout.ContentLayout, null, showLoader ? /* @__PURE__ */ react.createElement(build.LoadingIndicatorPage, null) : /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 4, background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "h2" }, formatMessage({
      id: "global.settings",
      defaultMessage: "Settings"
    })), /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 4 }, /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 6, m: 6, s: 12 }, /* @__PURE__ */ react.createElement(
    ...
    )), /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 6, m: 6, s: 12 }, /* @__PURE__ */ react.createElement(
      Select.Select,
      {
        disabled: !canUpdate,
        hint: formatMessage({
      ...
      roles.map(({ id, name }) => /* @__PURE__ */ react.createElement(Select.Option, { key: id, value: id.toString() }, name))
    )))))
  )));
};
