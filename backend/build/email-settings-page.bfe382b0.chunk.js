...
const Configuration = ({ config }) => {
  ...
  return /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 4 }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 1 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "h2" }, formatMessage({
  ...
  ))), /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 5 }, /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 6, s: 12 }, /* @__PURE__ */ react.createElement(
    TextInput.TextInput,
    {
      name: "shipper-email",
      label: formatMessage({
    ...
    /* @__PURE__ */ react.createElement(Select.Option, { value: config.provider }, config.provider)
  ))));
};
...
const SettingsPage = () => {
  ...
  if (isLoading) {
    return /* @__PURE__ */ react.createElement(Main.Main, { labelledBy: "title", "aria-busy": "true" }, /* @__PURE__ */ react.createElement(components_EmailHeader, null), /* @__PURE__ */ react.createElement(Layout.ContentLayout, null, /* @__PURE__ */ react.createElement(build.LoadingIndicatorPage, null)));
  }
  return /* @__PURE__ */ react.createElement(Main.Main, { labelledBy: "title", "aria-busy": isSubmitting }, /* @__PURE__ */ react.createElement(components_EmailHeader, null), /* @__PURE__ */ react.createElement(Layout.ContentLayout, null, /* @__PURE__ */ react.createElement("form", { onSubmit: handleSubmit }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 7 }, /* @__PURE__ */ react.createElement(
    Box.Box,
    {
      background: "neutral0",
      hasRadius: true,
    ...
    })), /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 5, alignItems: "end" }, /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 6, s: 12 }, /* @__PURE__ */ react.createElement(
      TextInput.TextInput,
      {
    ...
    )), /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 7, s: 12 }, /* @__PURE__ */ react.createElement(
      Button.Button,
      {
