...
const BaseForm = ({ locale }) => {
  ...
  return /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 4 }, /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 6 }, /* @__PURE__ */ react.createElement(
    Select.Select,
    {
      label: formatMessage({
    ...
    /* @__PURE__ */ react.createElement(Select.Option, { value: (localeDetails == null ? void 0 : localeDetails.code) || locale.code }, (localeDetails == null ? void 0 : localeDetails.name) || locale.code)
...
const ModalEdit = ({ locale, onClose }) => {
  ...
  return /* @__PURE__ */ react.createElement(ModalLayout.ModalLayout, { onClose, labelledBy: "edit-locale-title" }, /* @__PURE__ */ react.createElement(
    dist.Formik,
    {
      initialValues: {
    ...
    /* @__PURE__ */ react.createElement(build.Form, null, /* @__PURE__ */ react.createElement(ModalLayout.ModalHeader, null, /* @__PURE__ */ react.createElement(Typography.Typography, { fontWeight: "bold", textColor: "neutral800", as: "h2", id: "edit-locale-title" }, formatMessage({
      id: (0,utils/* getTrad */.O)("Settings.list.actions.edit"),
      defaultMessage: "Edit a locale"
    }))), /* @__PURE__ */ react.createElement(ModalLayout.ModalBody, null, /* @__PURE__ */ react.createElement(
      Tabs.TabGroup,
      {
        label: formatMessage({
      ...
      /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(Typography.Typography, { as: "h2" }, formatMessage({
        id: (0,utils/* getTrad */.O)("Settings.locales.modal.title"),
        defaultMessage: "Configurations"
      ...
      /* @__PURE__ */ react.createElement(Box.Box, { paddingTop: 7, paddingBottom: 7 }, /* @__PURE__ */ react.createElement(Tabs.TabPanels, null, /* @__PURE__ */ react.createElement(Tabs.TabPanel, null, /* @__PURE__ */ react.createElement(ModalEdit_BaseForm, { locale })), /* @__PURE__ */ react.createElement(Tabs.TabPanel, null, /* @__PURE__ */ react.createElement(ModalEdit_AdvancedForm, { isDefaultLocale: Boolean(locale && locale.isDefault) }))))
      ...
      ModalLayout.ModalFooter,
      {
        ...
        endActions: /* @__PURE__ */ react.createElement(Button.Button, { type: "submit", startIcon: /* @__PURE__ */ react.createElement((Check_default()), null), disabled: isEditing }, formatMessage({ id: "global.save" }))
      }
    ))
  ));
};
...
const LocaleSelect = react.memo(({ value, onClear, onLocaleChange, error }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    options.map((option) => /* @__PURE__ */ react.createElement(Combobox.ComboboxOption, { value: option.value, key: option.value }, option.label))
  );
});
...
const ModalCreate = ({ onClose }) => {
  ...
  return /* @__PURE__ */ react.createElement(ModalLayout.ModalLayout, { onClose, labelledBy: "add-locale-title" }, /* @__PURE__ */ react.createElement(
    dist.Formik,
    {
    ...
    /* @__PURE__ */ react.createElement(build.Form, null, /* @__PURE__ */ react.createElement(ModalLayout.ModalHeader, null, /* @__PURE__ */ react.createElement(Typography.Typography, { fontWeight: "bold", textColor: "neutral800", as: "h2", id: "add-locale-title" }, formatMessage({
      ...
      /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(Typography.Typography, { as: "h2", variant: "beta" }, formatMessage({
        id: (0,utils/* getTrad */.O)("Settings.locales.modal.title"),
        defaultMessage: "Configurations"
      })), /* @__PURE__ */ react.createElement(Tabs.Tabs, null, /* @__PURE__ */ react.createElement(Tabs.Tab, null, formatMessage({
        id: (0,utils/* getTrad */.O)("Settings.locales.modal.base"),
      ...
      /* @__PURE__ */ react.createElement(Divider.Divider, null),
      /* @__PURE__ */ react.createElement(Box.Box, { paddingTop: 7, paddingBottom: 7 }, /* @__PURE__ */ react.createElement(Tabs.TabPanels, null, /* @__PURE__ */ react.createElement(Tabs.TabPanel, null, /* @__PURE__ */ react.createElement(ModalCreate_BaseForm, null)), /* @__PURE__ */ react.createElement(Tabs.TabPanel, null, /* @__PURE__ */ react.createElement(ModalCreate_AdvancedForm, null))))
    )), /* @__PURE__ */ react.createElement(
      ModalLayout.ModalFooter,
      {
        ...
        endActions: /* @__PURE__ */ react.createElement(Button.Button, { type: "submit", startIcon: /* @__PURE__ */ react.createElement((Check_default()), null), disabled: isAdding }, formatMessage({ id: "global.save", defaultMessage: "Save" }))
      }
    ))
  ));
};
...
const LocaleTable = ({ locales, onDeleteLocale, onEditLocale }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(Table.Table, { colCount: 4, rowCount: locales.length + 1 }, /* @__PURE__ */ react.createElement(Table.Thead, null, /* @__PURE__ */ react.createElement(Table.Tr, null, /* @__PURE__ */ react.createElement(Table.Th, null, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: (0,utils/* getTrad */.O)("Settings.locales.row.id") }))), /* @__PURE__ */ react.createElement(Table.Th, null, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: (0,utils/* getTrad */.O)("Settings.locales.row.displayName") }))), /* @__PURE__ */ react.createElement(Table.Th, null, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: (0,utils/* getTrad */.O)("Settings.locales.row.default-locale") }))), /* @__PURE__ */ react.createElement(Table.Th, null, /* @__PURE__ */ react.createElement(VisuallyHidden.VisuallyHidden, null, "Actions")))), /* @__PURE__ */ react.createElement(Table.Tbody, null, locales.map((locale) => /* @__PURE__ */ react.createElement(
    Table.Tr,
    __spreadValues({
      key: locale.id
    }, (0,build.onRowClick)({
    ...
    /* @__PURE__ */ react.createElement(Table.Td, null, /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "neutral800" }, locale.id)),
    /* @__PURE__ */ react.createElement(Table.Td, null, /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "neutral800" }, locale.name)),
    /* @__PURE__ */ react.createElement(Table.Td, null, /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "neutral800" }, locale.isDefault ? formatMessage({ id: (0,utils/* getTrad */.O)("Settings.locales.default") }) : null)),
    /* @__PURE__ */ react.createElement(Table.Td, null, /* @__PURE__ */ react.createElement(
      Stack.Stack,
      __spreadValues({
        horizontal: true,
        spacing: 1,
...
const LocaleList = ({ canUpdateLocale, canDeleteLocale, onToggleCreateModal, isCreating }) => {
  ...
  return /* @__PURE__ */ react.createElement(Main.Main, { tabIndex: -1 }, /* @__PURE__ */ react.createElement(
    Layout.HeaderLayout,
    {
      primaryAction: /* @__PURE__ */ react.createElement(Button.Button, { startIcon: /* @__PURE__ */ react.createElement((Plus_default()), null), onClick: onToggleCreateModal, size: "S" }, formatMessage({ id: (0,utils/* getTrad */.O)("Settings.list.actions.add") })),
  ...
  ), /* @__PURE__ */ react.createElement(Layout.ContentLayout, null, (locales == null ? void 0 : locales.length) > 0 ? /* @__PURE__ */ react.createElement(
    ...
    {
      icon: /* @__PURE__ */ react.createElement((EmptyDocuments_default()), { width: void 0, height: void 0 }),
      content: formatMessage({ id: (0,utils/* getTrad */.O)("Settings.list.empty.title") }),
      action: onToggleCreateModal ? /* @__PURE__ */ react.createElement(Button.Button, { variant: "secondary", startIcon: /* @__PURE__ */ react.createElement((Plus_default()), null), onClick: onToggleCreateModal }, formatMessage({ id: (0,utils/* getTrad */.O)("Settings.list.actions.add") })) : null
    }
