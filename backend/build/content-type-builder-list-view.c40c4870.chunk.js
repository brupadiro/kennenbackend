...
function ComponentCard({ component, dzName, index, isActive, isInDevelopmentMode, onClick }) {
  ...
  return /* @__PURE__ */ react.createElement("button", { type: "button", onClick }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(StackCentered, { spacing: 1 }, /* @__PURE__ */ react.createElement(StyledFontAwesomeIcon, { icon: icon || "dice-d6" }), /* @__PURE__ */ react.createElement(Box.Box, { maxWidth: `calc(${(0,build.pxToRem)(140)} - 32px)` }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "pi", fontWeight: "bold", ellipsis: true }, displayName))),
...
const NestedTFooter = (_a) => {
  ...
  return /* @__PURE__ */ react.createElement(ButtonBox, NestedTFooter_spreadValues({ paddingBottom: 4, paddingTop: 4, as: "button", type: "button" }, props), /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(IconBox, { color, "aria-hidden": true, background: `${color}200` }, icon), /* @__PURE__ */ react.createElement(Box.Box, { paddingLeft: 3 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "pi", fontWeight: "bold", textColor: `${color}600` }, children))));
};
...
function List({
  ...
  if (items.length === 0 && isMain) {
    return /* @__PURE__ */ react.createElement(Table.Table, { colCount: 2, rowCount: 2 }, /* @__PURE__ */ react.createElement(Table.Thead, null, /* @__PURE__ */ react.createElement(Table.Tr, null, /* @__PURE__ */ react.createElement(Table.Th, null, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: "global.name", defaultMessage: "Name" }))), /* @__PURE__ */ react.createElement(Table.Th, null, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: "global.type", defaultMessage: "Type" }))))), /* @__PURE__ */ react.createElement(
      build.EmptyBodyTable,
      {
        action: /* @__PURE__ */ react.createElement(Button.Button, { onClick: onClickAddField, size: "L", startIcon: /* @__PURE__ */ react.createElement((Plus_default()), null), variant: "secondary" }, formatMessage({
  ...
  return /* @__PURE__ */ react.createElement(List_BoxWrapper, null, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement("table", null, isMain && /* @__PURE__ */ react.createElement("thead", null, /* @__PURE__ */ react.createElement("tr", null, /* @__PURE__ */ react.createElement("th", null, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: "global.name", defaultMessage: "Name" }))), /* @__PURE__ */ react.createElement("th", { colSpan: "2" }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: "global.type", defaultMessage: "Type" }))))), /* @__PURE__ */ react.createElement("tbody", null, items.map((item) => {
      const { type } = item;
  ...
  ), isMain && isInDevelopmentMode && /* @__PURE__ */ react.createElement(Table.TFooter, { icon: /* @__PURE__ */ react.createElement((Plus_default()), null), onClick: onClickAddField }, formatMessage({
...
function ListRow({
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement("td", { style: { position: "relative" } }, loopNumber !== 0 && /* @__PURE__ */ react.createElement(icons_Curve, { color: isFromDynamicZone ? "primary200" : "neutral150" }), /* @__PURE__ */ react.createElement(Stack.Stack, { paddingLeft: 2, spacing: 4, horizontal: true }, /* @__PURE__ */ react.createElement(AttributeIcon/* default */.Z, { type: src, customField }), /* @__PURE__ */ react.createElement(Typography.Typography, { fontWeight: "bold" }, name))),
    /* @__PURE__ */ react.createElement("td", null, target ? /* @__PURE__ */ react.createElement(Typography.Typography, null, formatMessage({
      id: (0,getTrad/* default */.Z)(
    ...
    /* @__PURE__ */ react.createElement("td", null, isInDevelopmentMode ? /* @__PURE__ */ react.createElement(Flex.Flex, ListRow_spreadValues({ justifyContent: "flex-end" }, build.stopPropagation), configurable ? /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, spacing: 1 }, !isMorph && /* @__PURE__ */ react.createElement(
    ...
    )) : /* @__PURE__ */ react.createElement((Lock_default()), null)) : (
      /*
      ...
      */
      /* @__PURE__ */ react.createElement(Box.Box, { height: (0,build.pxToRem)(32) })
    ))
  );
}
...
const ListView = () => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
    ...
    {
      id: "title",
      primaryAction: isInDevelopmentMode && /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, spacing: 2 }, !isCreatingFirstContentType && /* @__PURE__ */ react.createElement(
        Button.Button,
        {
      ...
      secondaryAction: isInDevelopmentMode && !isFromPlugin && !isCreatingFirstContentType && /* @__PURE__ */ react.createElement(Button.Button, { startIcon: /* @__PURE__ */ react.createElement((Pencil_default()), null), variant: "tertiary", onClick: onEdit }, formatMessage({
        id: "app.utils.edit",
        defaultMessage: "Edit"
      })),
      ...
      navigationAction: /* @__PURE__ */ react.createElement(build.Link, { startIcon: /* @__PURE__ */ react.createElement((ArrowLeft_default()), null), to: "/plugins/content-type-builder/" }, formatMessage({
        id: "global.back",
        defaultMessage: "Back"
      }))
    }
  ), /* @__PURE__ */ react.createElement(Layout.ContentLayout, null, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 4 }, /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "flex-end" }, /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, spacing: 2 }, /* @__PURE__ */ react.createElement(
  ...
  ))), /* @__PURE__ */ react.createElement(Box.Box, { background: "neutral0", shadow: "filterShadow", hasRadius: true }, /* @__PURE__ */ react.createElement(
    components_List,
    {
      items: attributes,
