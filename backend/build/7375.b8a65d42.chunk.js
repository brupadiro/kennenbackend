...
const LoadingView = ({ apiTokenName }) => {
  ...
  return /* @__PURE__ */ react.createElement(Main.Main, { "aria-busy": "true" }, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, { name: "API Tokens" }), /* @__PURE__ */ react.createElement(
    Layout.HeaderLayout,
    {
      primaryAction: /* @__PURE__ */ react.createElement(Button.Button, { disabled: true, startIcon: /* @__PURE__ */ react.createElement((Check_default()), null), type: "button", size: "L" }, formatMessage({ id: "global.save", defaultMessage: "Save" })),
...
const FormHead = ({ apiToken, setApiToken, canEditInputs, canRegenerate, isSubmitting }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    Layout.HeaderLayout,
    {
      ...
      primaryAction: canEditInputs ? /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, spacing: 2 }, canRegenerate && (apiToken == null ? void 0 : apiToken.id) && /* @__PURE__ */ react.createElement(components_Regenerate, { onRegenerate: handleRegenerate, idToRegenerate: apiToken == null ? void 0 : apiToken.id }), /* @__PURE__ */ react.createElement(
        Button.Button,
        {
      ...
      navigationAction: /* @__PURE__ */ react.createElement(build.Link, { startIcon: /* @__PURE__ */ react.createElement((ArrowLeft_default()), null), to: "/settings/api-tokens" }, formatMessage({
        id: "global.back",
        defaultMessage: "Back"
      }))
    }
...
const FormApiTokenContainer = ({
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 4 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "h2" }, formatMessage({
    ...
    })), /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 5 }, /* @__PURE__ */ react.createElement(Grid.GridItem, { key: "name", col: 6, xs: 12 }, /* @__PURE__ */ react.createElement(
      TextInput.TextInput,
      {
        name: "name",
    ...
    )), /* @__PURE__ */ react.createElement(Grid.GridItem, { key: "description", col: 6, xs: 12 }, /* @__PURE__ */ react.createElement(
      Textarea.Textarea,
      {
        label: formatMessage({
      ...
      values.description
    )), /* @__PURE__ */ react.createElement(Grid.GridItem, { key: "lifespan", col: 6, xs: 12 }, /* @__PURE__ */ react.createElement(
      Select.Select,
      {
        name: "lifespan",
        label: formatMessage({
      ...
      /* @__PURE__ */ react.createElement(Select.Option, { value: "604800000" }, formatMessage({
        id: "Settings.apiTokens.duration.7-days",
        defaultMessage: "7 days"
      })),
      /* @__PURE__ */ react.createElement(Select.Option, { value: "2592000000" }, formatMessage({
        id: "Settings.apiTokens.duration.30-days",
        defaultMessage: "30 days"
      })),
      /* @__PURE__ */ react.createElement(Select.Option, { value: "7776000000" }, formatMessage({
        id: "Settings.apiTokens.duration.90-days",
        defaultMessage: "90 days"
      })),
      /* @__PURE__ */ react.createElement(Select.Option, { value: "0" }, formatMessage({
        id: "Settings.apiTokens.duration.unlimited",
        defaultMessage: "Unlimited"
      }))
    ), /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "pi", textColor: "neutral600" }, !isCreating && `${formatMessage({
      ...
      lang
    )}`)), /* @__PURE__ */ react.createElement(Grid.GridItem, { key: "type", col: 6, xs: 12 }, /* @__PURE__ */ react.createElement(
      Select.Select,
      {
        name: "type",
        label: formatMessage({
      ...
      /* @__PURE__ */ react.createElement(Select.Option, { value: "read-only" }, formatMessage({
        id: "Settings.apiTokens.types.read-only",
        defaultMessage: "Read-only"
      })),
      /* @__PURE__ */ react.createElement(Select.Option, { value: "full-access" }, formatMessage({
        id: "Settings.apiTokens.types.full-access",
        defaultMessage: "Full access"
      })),
      /* @__PURE__ */ react.createElement(Select.Option, { value: "custom" }, formatMessage({
...
const CollapsableContentType = ({
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Accordion.AccordionToggle, { title: (0,lodash.capitalize)(label) }),
    /* @__PURE__ */ react.createElement(Accordion.AccordionContent, null, controllers == null ? void 0 : controllers.map((controller) => {
      ...
      return /* @__PURE__ */ react.createElement(Box.Box, { key: `${label}.${controller == null ? void 0 : controller.controller}` }, /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "space-between", alignItems: "center", padding: 4 }, /* @__PURE__ */ react.createElement(Box.Box, { paddingRight: 4 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, controller == null ? void 0 : controller.controller)), /* @__PURE__ */ react.createElement(Border, null), /* @__PURE__ */ react.createElement(Box.Box, { paddingLeft: 4 }, /* @__PURE__ */ react.createElement(
        Checkbox.Checkbox,
        {
        ...
        "Select all"
      ))), /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 4, padding: 4 }, (controller == null ? void 0 : controller.actions) && (controller == null ? void 0 : controller.actions.map((action) => {
        return /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 6, key: action.actionId }, /* @__PURE__ */ react.createElement(
          CheckBoxWrapper,
          {
...
const ContentTypesSection = (_a) => {
  ...
  return /* @__PURE__ */ react.createElement(Box.Box, { padding: 4, background: "neutral0" }, section && section.map((api, index) => /* @__PURE__ */ react.createElement(
...
const ActionBoundRoutes = () => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    selectedAction ? /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 2 }, (_a = routes[actionSection]) == null ? void 0 : _a.map((route) => {
      var _a2, _b;
...
const Permissions = (_a) => {
  ...
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 0, shadow: "filterShadow", hasRadius: true, background: "neutral0" }, /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 7, paddingTop: 6, paddingBottom: 6, paddingLeft: 7, paddingRight: 7 }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 2 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "h2" }, formatMessage({
...
const FormBody = ({
  ...
  return /* @__PURE__ */ react.createElement(Layout.ContentLayout, null, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 6 }, Boolean(apiToken == null ? void 0 : apiToken.name) && /* @__PURE__ */ react.createElement(ContentBox, { apiToken: apiToken == null ? void 0 : apiToken.accessKey }), /* @__PURE__ */ react.createElement(
...
const ApiTokenCreateView = () => {
  ...
  return /* @__PURE__ */ react.createElement(ApiTokenPermissionsContextProvider, { value: providerValue }, /* @__PURE__ */ react.createElement(Main.Main, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, { name: "API Tokens" }), /* @__PURE__ */ react.createElement(
    dist.Formik,
    {
