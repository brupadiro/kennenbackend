...
const Modal = ({ onClose, onSkip, children, hideSkip }) => {
  ...
  return /* @__PURE__ */ react.createElement(Portal.Portal, null, /* @__PURE__ */ react.createElement(ModalWrapper, { onClick: onClose, padding: 8, justifyContent: "center" }, /* @__PURE__ */ react.createElement(FocusTrap.FocusTrap, { onEscape: onClose }, /* @__PURE__ */ react.createElement(
    Stack.Stack,
    {
      background: "neutral0",
    ...
    /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "flex-end" }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Box.Box, { paddingLeft: 7, paddingRight: 7, paddingBottom: hideSkip ? 8 : 0 }, children),
    !hideSkip && /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "flex-end" }, /* @__PURE__ */ react.createElement(Button.Button, { variant: "tertiary", onClick: onSkip }, formatMessage({
...
const Content = ({ id, defaultMessage }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 4, paddingBottom: 6 }, formatMessage(
    { id, defaultMessage },
    {
      ...
      b: (children) => /* @__PURE__ */ react.createElement(Typography.Typography, { fontWeight: "semiBold" }, children),
      p: (children) => /* @__PURE__ */ react.createElement(Typography.Typography, null, children),
      light: (children) => /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "neutral600" }, children),
      ul: (children) => /* @__PURE__ */ react.createElement(Box.Box, { paddingLeft: 6 }, /* @__PURE__ */ react.createElement("ul", null, children)),
...
const StepNumberWithPadding = ({ number, last, type }) => /* @__PURE__ */ react.createElement(Box.Box, { paddingTop: 3, paddingBottom: last ? 0 : 3 }, /* @__PURE__ */ react.createElement(StepNumber/* default */.Z, { number, type }));
...
const StepperModal = ({
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Flex.Flex, { alignItems: "stretch" }, /* @__PURE__ */ react.createElement(Flex.Flex, { marginRight: 8, justifyContent: "center", minWidth: (0,build.pxToRem)(30) }, hasSectionBefore && /* @__PURE__ */ react.createElement(StepLine/* default */.Z, { type: constants/* IS_DONE */.hx, minHeight: (0,build.pxToRem)(24) })), /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "primary600" }, formatMessage({
    id: "app.components.GuidedTour.title",
    defaultMessage: "3 steps to get started"
  }))), /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(Flex.Flex, { marginRight: 8, minWidth: (0,build.pxToRem)(30) }, /* @__PURE__ */ react.createElement(
    components_StepNumberWithPadding,
    {
      number: sectionIndex + 1,
      type: hasStepsBefore ? constants/* IS_DONE */.hx : constants/* IS_ACTIVE */.lW
    }
  )), /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "alpha", fontWeight: "bold", textColor: "neutral800", as: "h3", id: "title" }, formatMessage(title))), /* @__PURE__ */ react.createElement(Flex.Flex, { alignItems: "stretch" }, /* @__PURE__ */ react.createElement(Flex.Flex, { marginRight: 8, direction: "column", justifyContent: "center", minWidth: (0,build.pxToRem)(30) }, hasSectionAfter && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(StepLine/* default */.Z, { type: constants/* IS_DONE */.hx }), hasStepsBefore && /* @__PURE__ */ react.createElement(components_StepNumberWithPadding, { number: nextSectionIndex + 1, type: constants/* IS_ACTIVE */.lW, last: true }))), /* @__PURE__ */ react.createElement(Box.Box, null, /* @__PURE__ */ react.createElement(components_Content, __spreadValues({}, content)), cta && (cta.target ? /* @__PURE__ */ react.createElement(build.LinkButton, { endIcon: /* @__PURE__ */ react.createElement((ArrowRight_default()), null), onClick: onCtaClick, to: cta.target }, formatMessage(cta.title)) : /* @__PURE__ */ react.createElement(Button.Button, { endIcon: /* @__PURE__ */ react.createElement((ArrowRight_default()), null), onClick: onCtaClick }, formatMessage(cta.title))))), hasStepsBefore && hasSectionAfter && /* @__PURE__ */ react.createElement(Box.Box, { paddingTop: 3 }, /* @__PURE__ */ react.createElement(Flex.Flex, { marginRight: 8, justifyContent: "center", width: (0,build.pxToRem)(30) }, /* @__PURE__ */ react.createElement(StepLine/* default */.Z, { type: constants/* IS_DONE */.hx, minHeight: (0,build.pxToRem)(24) }))));
};
...
const LeftMenu = ({ generalSectionLinks, pluginsSectionLinks }) => {
  ...
  return /* @__PURE__ */ react.createElement(MainNav.MainNav, { condensed }, /* @__PURE__ */ react.createElement(
  ...
  ), /* @__PURE__ */ react.createElement(Divider.Divider, null), /* @__PURE__ */ react.createElement(MainNav.NavSections, null, /* @__PURE__ */ react.createElement(MainNav.NavLink, { as: react_router_dom_min.NavLink, to: "/content-manager", icon: /* @__PURE__ */ react.createElement((Write_default()), null) }, formatMessage({ id: "global.content-manager", defaultMessage: "Content manager" })), pluginsSectionLinks.length > 0 ? /* @__PURE__ */ react.createElement(
    MainNav.NavSection,
    {
      label: formatMessage({
    ...
    pluginsSectionLinks.map((link) => {
      ...
      return /* @__PURE__ */ react.createElement(MainNav.NavLink, { as: react_router_dom_min.NavLink, to: link.to, key: link.to, icon: /* @__PURE__ */ react.createElement(Icon, null) }, formatMessage(link.intlLabel));
    })
    ...
    /* @__PURE__ */ react.createElement(FocusTrap.FocusTrap, { onEscape: handleToggleUserLinks }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 0 }, /* @__PURE__ */ react.createElement(LinkUser, { tabIndex: 0, onClick: handleToggleUserLinks, to: "/me" }, /* @__PURE__ */ react.createElement(Typography.Typography, null, formatMessage({
      id: "global.profile",
      defaultMessage: "Profile"
    }))), /* @__PURE__ */ react.createElement(LinkUser, { tabIndex: 0, onClick: handleLogout, logout: "logout", to: "/auth/login" }, /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "danger600" }, formatMessage({
      id: "app.components.LeftMenu.logout",
      defaultMessage: "Logout"
    })), /* @__PURE__ */ react.createElement((Exit_default()), null))))
  ), /* @__PURE__ */ react.createElement(MainNav.NavCondense, { onClick: () => setCondensed((s) => !s) }, condensed ? formatMessage({
...
const AppLayout = ({ children, sideNav }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(Box.Box, { background: "neutral100" }, /* @__PURE__ */ react.createElement(Main.SkipToContent, null, formatMessage({ id: "skipToContent", defaultMessage: "Skip to content" })), /* @__PURE__ */ react.createElement(Flex.Flex, { alignItems: "flex-start" }, sideNav, /* @__PURE__ */ react.createElement(FlexBox, null, children)));
};
AppLayout.propTypes = {
  children: (prop_types_default()).node.isRequired,
...
const Onboarding = () => {
  ...
  return /* @__PURE__ */ react.createElement(OnboardingWrapper, { as: "aside" }, /* @__PURE__ */ react.createElement(
    ...
    !isOpen && /* @__PURE__ */ react.createElement(index_es/* FontAwesomeIcon */.G, { icon: free_solid_svg_icons.faQuestion }),
    isOpen && /* @__PURE__ */ react.createElement(index_es/* FontAwesomeIcon */.G, { icon: free_solid_svg_icons.faTimes })
  ), isOpen && /* @__PURE__ */ react.createElement(FocusTrap.FocusTrap, { onEscape: handleClick }, /* @__PURE__ */ react.createElement(
    LinksWrapper,
    {
      background: "neutral0",
      hasRadius: true,
...
const StepLine = (_a) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
    _strapi_design_system_Box__WEBPACK_IMPORTED_MODULE_2__.Box,
    __spreadValues({
...
const StepNumber = ({ type, number }) => {
  if (type === _constants__WEBPACK_IMPORTED_MODULE_6__/* .IS_DONE */ .hx) {
    return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
      _strapi_design_system_Flex__WEBPACK_IMPORTED_MODULE_2__.Flex,
      {
      ...
      /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Icon__WEBPACK_IMPORTED_MODULE_4__.Icon, { as: (_strapi_icons_Check__WEBPACK_IMPORTED_MODULE_5___default()), "aria-hidden": true, width: (0,_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.pxToRem)(16), color: "neutral0" })
    );
  }
  if (type === _constants__WEBPACK_IMPORTED_MODULE_6__/* .IS_ACTIVE */ .lW) {
    return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
      ...
      /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Typography__WEBPACK_IMPORTED_MODULE_3__.Typography, { fontWeight: "semiBold", textColor: "neutral0" }, number)
    );
  }
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
    _strapi_design_system_Flex__WEBPACK_IMPORTED_MODULE_2__.Flex,
    ...
    /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Typography__WEBPACK_IMPORTED_MODULE_3__.Typography, { fontWeight: "semiBold", textColor: "neutral600" }, number)
  );
};
