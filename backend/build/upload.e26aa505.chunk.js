...
const PaginationFooter = ({ pagination }) => {
  return /* @__PURE__ */ react.createElement(Box.Box, { paddingTop: 6 }, /* @__PURE__ */ react.createElement(Flex.Flex, { alignItems: "flex-end", justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(build.PageSizeURLQuery, null), /* @__PURE__ */ react.createElement(build.PaginationURLQuery, { pagination })));
};
...
const BulkMoveDialog = ({ onClose, selected, currentFolder }) => {
  ...
  if (isLoading) {
    return /* @__PURE__ */ react.createElement(ModalLayout.ModalLayout, { onClose: handleClose, labelledBy: "title" }, /* @__PURE__ */ react.createElement(ModalLayout.ModalBody, null, /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "center", paddingTop: 4, paddingBottom: 4 }, /* @__PURE__ */ react.createElement(Loader.Loader, null, formatMessage({
  ...
  return /* @__PURE__ */ react.createElement(ModalLayout.ModalLayout, { onClose: handleClose, labelledBy: "title" }, /* @__PURE__ */ react.createElement(dist.Formik, { validateOnChange: false, onSubmit: handleSubmit, initialValues: initialFormData }, ({ values, errors, setFieldValue }) => /* @__PURE__ */ react.createElement(build.Form, { noValidate: true }, /* @__PURE__ */ react.createElement(ModalLayout.ModalHeader, null, /* @__PURE__ */ react.createElement(Typography.Typography, { fontWeight: "bold", textColor: "neutral800", as: "h2", id: "title" }, formatMessage({
    id: (0,utils/* getTrad */.OB)("modal.folder.move.title"),
    defaultMessage: "Move elements to"
  }))), /* @__PURE__ */ react.createElement(ModalLayout.ModalBody, null, /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 4 }, /* @__PURE__ */ react.createElement(Grid.GridItem, { xs: 12, col: 12 }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 1 }, /* @__PURE__ */ react.createElement(Field.FieldLabel, { htmlFor: "folder-destination" }, formatMessage({
...
const BulkActions = ({ selected, onSuccess, currentFolder }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, spacing: 2, paddingBottom: 5 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "epsilon", textColor: "neutral600" }, formatMessage(
    {
...
const Header = ({
  ...
  return /* @__PURE__ */ react.createElement(
    Layout.HeaderLayout,
    {
      ...
      primaryAction: canCreate && /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, spacing: 2 }, /* @__PURE__ */ react.createElement(Button.Button, { startIcon: /* @__PURE__ */ react.createElement((Plus_default()), null), variant: "secondary", onClick: onToggleEditFolderDialog }, formatMessage({
        id: (0,utils/* getTrad */.OB)("header.actions.add-folder"),
        defaultMessage: "Add new folder"
      })), /* @__PURE__ */ react.createElement(Button.Button, { startIcon: /* @__PURE__ */ react.createElement((Plus_default()), null), onClick: onToggleUploadAssetDialog }, formatMessage({
...
const EmptyOrNoPermissions = ({ canCreate, isFiltering, canRead, onActionClick }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    EmptyAssets/* EmptyAssets */.i,
    {
      ...
      action: canCreate && !isFiltering && /* @__PURE__ */ react.createElement(Button.Button, { variant: "secondary", startIcon: /* @__PURE__ */ react.createElement((Plus_default()), null), onClick: onActionClick }, formatMessage({
        id: (0,utils/* getTrad */.OB)("header.actions.add-assets"),
        defaultMessage: "Add new assets"
      })),
...
const MediaLibrary = () => {
  ...
  return /* @__PURE__ */ react.createElement(Layout.Layout, null, /* @__PURE__ */ react.createElement(Main.Main, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(
    Header,
    {
  ...
  ), /* @__PURE__ */ react.createElement(Layout.ContentLayout, null, selected.length > 0 && /* @__PURE__ */ react.createElement(BulkActions, { currentFolder, selected, onSuccess: selectAll }), isLoading && /* @__PURE__ */ react.createElement(build.LoadingIndicatorPage, null), (assetsError || foldersError) && /* @__PURE__ */ react.createElement(build.AnErrorOccurred, null), folderCount === 0 && assetCount === 0 && /* @__PURE__ */ react.createElement(
    ...
    folders.map((folder) => {
      ...
      return /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 3, key: `folder-${folder.id}` }, /* @__PURE__ */ react.createElement(
        ...
        /* @__PURE__ */ react.createElement(FolderCard/* FolderCardBody */.Bu, null, /* @__PURE__ */ react.createElement(FolderCard/* FolderCardBodyAction */.u6, { to: url }, /* @__PURE__ */ react.createElement(Flex.Flex, { as: "h2", direction: "column", alignItems: "start", maxWidth: "100%" }, /* @__PURE__ */ react.createElement(TypographyMaxWidth, { fontWeight: "semiBold", ellipsis: true }, folder.name, /* @__PURE__ */ react.createElement(VisuallyHidden.VisuallyHidden, null, ":")), /* @__PURE__ */ react.createElement(
          TypographyMaxWidth,
          {
            as: "span",
  ...
  ), assetCount > 0 && folderCount > 0 && /* @__PURE__ */ react.createElement(Box.Box, { paddingTop: 6, paddingBottom: 4 }, /* @__PURE__ */ react.createElement(Divider.Divider, null)), assetCount > 0 && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
