...
const FormModal = ({
  ...
  return /* @__PURE__ */ react.createElement(ModalLayout.ModalLayout, { onClose: onToggle, labelledBy: "title" }, /* @__PURE__ */ react.createElement(ModalLayout.ModalHeader, null, /* @__PURE__ */ react.createElement(Breadcrumbs.Breadcrumbs, { label: headerBreadcrumbs.join(", ") }, headerBreadcrumbs.map((crumb) => /* @__PURE__ */ react.createElement(Breadcrumbs.Crumb, { key: crumb }, crumb)))), /* @__PURE__ */ react.createElement(
    dist.Formik,
    {
    ...
    ({ errors, handleChange, values }) => {
      return /* @__PURE__ */ react.createElement(build.Form, null, /* @__PURE__ */ react.createElement(ModalLayout.ModalBody, null, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 1 }, /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 5 }, layout.form.map((row) => {
        return row.map((input) => {
          return /* @__PURE__ */ react.createElement(Grid.GridItem, { key: input.name, col: input.size, xs: 12 }, /* @__PURE__ */ react.createElement(
            FormModal_Input,
...
const ProvidersPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Layout.Layout, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, { name: pageTitle }), /* @__PURE__ */ react.createElement(Main.Main, null, /* @__PURE__ */ react.createElement(
    Layout.HeaderLayout,
    {
      title: formatMessage({
        id: (0,utils/* getTrad */.OB)("HeaderNav.link.providers"),
  ...
  ), isLoading || isLoadingForPermissions ? /* @__PURE__ */ react.createElement(build.LoadingIndicatorPage, null) : /* @__PURE__ */ react.createElement(Layout.ContentLayout, null, /* @__PURE__ */ react.createElement(Table.Table, { colCount: 4, rowCount: rowCount + 1 }, /* @__PURE__ */ react.createElement(Table.Thead, null, /* @__PURE__ */ react.createElement(Table.Tr, null, /* @__PURE__ */ react.createElement(Table.Th, null, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, /* @__PURE__ */ react.createElement(VisuallyHidden.VisuallyHidden, null, formatMessage({ id: (0,utils/* getTrad */.OB)("Providers.image"), defaultMessage: "Image" })))), /* @__PURE__ */ react.createElement(Table.Th, null, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: "global.name", defaultMessage: "Name" }))), /* @__PURE__ */ react.createElement(Table.Th, null, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: (0,utils/* getTrad */.OB)("Providers.status"), defaultMessage: "Status" }))), /* @__PURE__ */ react.createElement(Table.Th, null, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma" }, /* @__PURE__ */ react.createElement(VisuallyHidden.VisuallyHidden, null, formatMessage({
    id: "global.settings",
    defaultMessage: "Settings"
  })))))), /* @__PURE__ */ react.createElement(Table.Tbody, null, providers.map((provider) => /* @__PURE__ */ react.createElement(
    Table.Tr,
    ...
    /* @__PURE__ */ react.createElement(Table.Td, { width: "" }, /* @__PURE__ */ react.createElement(index_es/* FontAwesomeIcon */.G, { icon: provider.icon })),
    /* @__PURE__ */ react.createElement(Table.Td, { width: "45%" }, /* @__PURE__ */ react.createElement(Typography.Typography, { fontWeight: "semiBold", textColor: "neutral800" }, provider.name)),
    /* @__PURE__ */ react.createElement(Table.Td, { width: "65%" }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Table.Td, Providers_spreadValues({}, build.stopPropagation), canUpdate && /* @__PURE__ */ react.createElement(
