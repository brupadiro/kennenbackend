  ...
  return /* @__PURE__ */ react.createElement(Main.Main, { "aria-busy": isSubmittingForm }, /* @__PURE__ */ react.createElement(
    ...
    ({ errors, values, handleChange, isSubmitting }) => {
      return /* @__PURE__ */ react.createElement(build.Form, null, /* @__PURE__ */ react.createElement(
        ...
        /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 4 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "h2" }, formatMessage({
        ...
        })), /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 6 }, /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 6, s: 12 }, /* @__PURE__ */ react.createElement(
          Select.Select,
          {
            label: formatMessage({
          ...
          data.roles.map((role) => {
            return /* @__PURE__ */ react.createElement(Select.Option, { key: role.type, value: role.type }, role.name);
          })
          ...
          return /* @__PURE__ */ react.createElement(Grid.GridItem, __spreadValues({ key: input.name }, input.size), /* @__PURE__ */ react.createElement(
            build.GenericInput,
