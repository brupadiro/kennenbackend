...
const AttributeIcon = (_a) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(IconBox, __spreadProps(__spreadValues({ as: Compo }, rest), { "aria-hidden": true }));
};
...
const AttributeOption = ({ type }) => {
  ...
  return /* @__PURE__ */ react.createElement(OptionBoxWrapper, { padding: 4, as: "button", hasRadius: true, type: "button", onClick: handleClick }, /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(AttributeIcon/* default */.Z, { type }), /* @__PURE__ */ react.createElement(Box.Box, { paddingLeft: 4 }, /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(Typography.Typography, { fontWeight: "bold" }, formatMessage({ id: (0,getTrad/* default */.Z)(`attribute.${type}`), defaultMessage: type }))), /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "pi", textColor: "neutral600" }, formatMessage({
...
const AttributeList = ({ attributes }) => /* @__PURE__ */ react.createElement(KeyboardNavigable.KeyboardNavigable, { tagName: "button" }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 8 }, attributes.map((attributeRow, index) => {
  return (
    // eslint-disable-next-line react/no-array-index-key
    /* @__PURE__ */ react.createElement(Grid.Grid, { key: index, gap: 0 }, attributeRow.map((attribute, index2) => {
      const { paddingLeft, paddingRight } = utils_getPadding(index2);
      return /* @__PURE__ */ react.createElement(Grid.GridItem, { key: attribute, col: 6, style: { height: "100%" } }, /* @__PURE__ */ react.createElement(
        Box.Box,
        {
          paddingLeft,
          paddingRight,
...
`;
const EmptyCardGrid = () => {
  return /* @__PURE__ */ react.createElement(Flex.Flex, { wrap: "wrap", gap: 4 }, [...Array(4)].map((_, idx) => {
    return /* @__PURE__ */ react.createElement(
      EmptyCard,
      {
        key: `empty-card-${idx}`,
...
const EmptyAttributes = () => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(Box.Box, { position: "relative" }, /* @__PURE__ */ react.createElement(EmptyCardGrid, null), /* @__PURE__ */ react.createElement(Box.Box, { position: "absolute", top: 6, width: "100%" }, /* @__PURE__ */ react.createElement(Flex.Flex, { alignItems: "center", justifyContent: "center", direction: "column" }, /* @__PURE__ */ react.createElement(Icon.Icon, { as: (EmptyDocuments_default()), color: "", width: "160px", height: "88px" }), /* @__PURE__ */ react.createElement(Box.Box, { paddingTop: 6, paddingBottom: 4 }, /* @__PURE__ */ react.createElement(Box.Box, { textAlign: "center" }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "p", textColor: "neutral600" }, formatMessage({
    id: (0,getTrad/* default */.Z)("modalForm.empty.heading"),
    defaultMessage: "Nothing in here yet."
  })), /* @__PURE__ */ react.createElement(Box.Box, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "p", textColor: "neutral600" }, formatMessage({
  ...
  }))))), /* @__PURE__ */ react.createElement(LinkButton.LinkButton, { to: "/marketplace", variant: "secondary", startIcon: /* @__PURE__ */ react.createElement((Plus_default()), null) }, formatMessage({
...
const CustomFieldOption = ({ customFieldUid, customField }) => {
  ...
  return /* @__PURE__ */ react.createElement(OptionBoxWrapper, { padding: 4, as: "button", hasRadius: true, type: "button", onClick: handleClick }, /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(AttributeIcon/* default */.Z, { type, customField: customFieldUid }), /* @__PURE__ */ react.createElement(Box.Box, { paddingLeft: 4 }, /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(Typography.Typography, { fontWeight: "bold" }, formatMessage(intlLabel))), /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "pi", textColor: "neutral600" }, formatMessage(intlDescription))))));
};
...
const CustomFieldsList = () => {
  ...
  return /* @__PURE__ */ react.createElement(KeyboardNavigable.KeyboardNavigable, { tagName: "button" }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 3 }, /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 0 }, sortedCustomFields.map(([uid, customField], index) => {
    const { paddingLeft, paddingRight } = utils_getPadding(index);
    return /* @__PURE__ */ react.createElement(Grid.GridItem, { key: uid, col: 6, style: { height: "100%" } }, /* @__PURE__ */ react.createElement(
      Box.Box,
      {
        paddingLeft,
        paddingRight,
...
const AttributeOptions = ({ attributes, forTarget, kind }) => {
  ...
  return /* @__PURE__ */ react.createElement(ModalLayout.ModalBody, { padding: 6 }, /* @__PURE__ */ react.createElement(
    Tabs.TabGroup,
    {
      label: formatMessage({
    ...
    /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "beta", as: "h2" }, formatMessage({ id: titleId, defaultMessage: "Select a field" })), /* @__PURE__ */ react.createElement(Tabs.Tabs, null, /* @__PURE__ */ react.createElement(Tabs.Tab, null, formatMessage({ id: defaultTabId, defaultMessage: "Default" })), /* @__PURE__ */ react.createElement(Tabs.Tab, null, formatMessage({ id: customTabId, defaultMessage: "Custom" })))),
    /* @__PURE__ */ react.createElement(Box.Box, { paddingBottom: 6 }, /* @__PURE__ */ react.createElement(Divider.Divider, null)),
    /* @__PURE__ */ react.createElement(Tabs.TabPanels, null, /* @__PURE__ */ react.createElement(Tabs.TabPanel, null, /* @__PURE__ */ react.createElement(AttributeOptions_AttributeList, { attributes })), /* @__PURE__ */ react.createElement(Tabs.TabPanel, null, /* @__PURE__ */ react.createElement(AttributeOptions_CustomFieldsList, null)))
  ));
};
...
const DraftAndPublishToggle = ({
  ...
  ), showWarning && /* @__PURE__ */ react.createElement(Dialog.Dialog, { onClose: handleToggle, title: "Confirmation", isOpen: showWarning }, /* @__PURE__ */ react.createElement(Dialog.DialogBody, { icon: /* @__PURE__ */ react.createElement((ExclamationMarkCircle_default()), null) }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 2 }, /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(TypographyTextAlign, { id: "confirm-description" }, formatMessage({
  ...
  }))), /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Typography.Typography, { id: "confirm-description" }, formatMessage({
    id: (0,getTrad/* default */.Z)("popUpWarning.draft-publish.second-message"),
    defaultMessage: "Are you sure you want to disable it?"
  }))))), /* @__PURE__ */ react.createElement(
    Dialog.DialogFooter,
    {
      startAction: /* @__PURE__ */ react.createElement(Button.Button, { onClick: handleToggle, variant: "tertiary" }, formatMessage({
        id: "components.popUpWarning.button.cancel",
        defaultMessage: "No, cancel"
      })),
      endAction: /* @__PURE__ */ react.createElement(Button.Button, { variant: "danger-light", onClick: handleConfirm }, formatMessage({
...
const FormModalHeader = ({
  ...
  if (isCreatingMainSchema) {
    ...
    return /* @__PURE__ */ react.createElement(ModalLayout.ModalHeader, null, /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(Box.Box, null, /* @__PURE__ */ react.createElement(AttributeIcon/* default */.Z, { type: icon })), /* @__PURE__ */ react.createElement(Box.Box, { paddingLeft: 3 }, /* @__PURE__ */ react.createElement(Typography.Typography, { fontWeight: "bold", textColor: "neutral800", as: "h2", id: "title" }, formatMessage({ id: headerId }, { name: displayName })))));
  }
  headers = [
    {
      label: displayName,
  ...
  return /* @__PURE__ */ react.createElement(ModalLayout.ModalHeader, null, /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, spacing: 3 }, /* @__PURE__ */ react.createElement(AttributeIcon/* default */.Z, { type: icon, customField: customFieldUid }), /* @__PURE__ */ react.createElement(Breadcrumbs.Breadcrumbs, { label: breadcrumbsLabel }, headers.map((header, index) => {
    var _a2;
...
const FormModalSubHeader = ({
  ...
  return /* @__PURE__ */ react.createElement(Stack.Stack, { direction: "column", alignItems: "flex-start", paddingBottom: 2, gap: 1 }, /* @__PURE__ */ react.createElement(Typography.Typography, { as: "h2", variant: "beta" }, formatMessage(
    {
  ...
  )), /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "pi", textColor: "neutral600" }, formatMessage({
...
const BooleanDefaultValueSelect = ({ intlLabel, name, options, onChange, value }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    options.map(({ metadatas: { intlLabel: intlLabel2, disabled, hidden }, key, value: value2 }) => {
      return /* @__PURE__ */ react.createElement(Select.Option, { key, value: value2, disabled, hidden }, intlLabel2.defaultMessage);
    })
  );
};
...
const CustomRadioGroup = ({ intlLabel, name, onChange, radios, value }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 2 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "pi", fontWeight: "bold", textColor: "neutral800", htmlFor: name, as: "label" }, formatMessage(intlLabel)), /* @__PURE__ */ react.createElement(Wrapper, { horizontal: true, spacing: 4, style: { alignItems: "stretch" } }, radios.map((radio) => {
    ...
    ), /* @__PURE__ */ react.createElement(Box.Box, { className: "option", padding: 4 }, /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(Box.Box, { paddingRight: 4 }, /* @__PURE__ */ react.createElement("span", { className: "checkmark" })), /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 2 }, /* @__PURE__ */ react.createElement(Typography.Typography, { fontWeight: "bold" }, formatMessage(radio.title)), /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "pi", textColor: "neutral600" }, formatMessage(radio.description))))));
  })));
};
...
const CheckboxWithNumberField = ({ error, intlLabel, modifiedData, name, onChange, value }) => {
  ...
  return /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 2 }, /* @__PURE__ */ react.createElement(
    Checkbox.Checkbox,
    {
      id: name,
      name,
    ...
    label
  ), showInput && /* @__PURE__ */ react.createElement(Box.Box, { paddingLeft: 6, style: { maxWidth: "200px" } }, type === "text" ? /* @__PURE__ */ react.createElement(
    TextInput.TextInput,
    {
      "aria-label": label,
      disabled,
...
const ComponentIconPicker = ({ error, intlLabel, name, onChange, value }) => {
  ...
  const errorMessage = error ? formatMessage({ id: error, defaultMessage: error }) : "";
  return /* @__PURE__ */ react.createElement(Box.Box, null, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 1 }, /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(
    Typography.Typography,
    {
      variant: "pi",
      fontWeight: "bold",
  ...
  )) : /* @__PURE__ */ react.createElement(IconButton.IconButton, { onClick: toggleSearch, "aria-label": "Edit", icon: /* @__PURE__ */ react.createElement((Search_default()), null), noBorder: true })), /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 1 }, /* @__PURE__ */ react.createElement(Box.Box, { padding: 1, background: "neutral100", borderColor: error ? "danger600" : "", hasRadius: true }, /* @__PURE__ */ react.createElement(
...
const RelationTargetPicker = ({ oneThatIsCreatingARelationWithAnother, target }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    allowedContentTypesForRelation.map(({ uid, title, restrictRelationsTo, plugin: plugin2 }) => {
      ...
      return /* @__PURE__ */ react.createElement(SimpleMenu.MenuItem, { key: uid, onClick: handleChange }, title, "\xA0", plugin2 && /* @__PURE__ */ react.createElement(react.Fragment, null, "(from: ", plugin2, ")"));
    })
  );
};
...
const RelationFormBox = ({
  ...
  return /* @__PURE__ */ react.createElement(Box.Box, { background: "neutral100", hasRadius: true, borderColor: "neutral200" }, /* @__PURE__ */ react.createElement(Flex.Flex, { paddingTop: isMain ? 4 : 1, paddingBottom: isMain ? 3 : 1, justifyContent: "center" }, isMain ? /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "pi", fontWeight: "bold", textColor: "neutral800" }, header) : /* @__PURE__ */ react.createElement(
    RelationField_RelationTargetPicker,
    {
      target,
      oneThatIsCreatingARelationWithAnother
    }
  )), /* @__PURE__ */ react.createElement(Divider.Divider, { background: "neutral200" }), /* @__PURE__ */ react.createElement(Box.Box, { padding: 4 }, /* @__PURE__ */ react.createElement(
    build.GenericInput,
    {
      disabled,
...
const RelationNaturePicker = ({
  ...
  return /* @__PURE__ */ react.createElement(Flex.Flex, { style: { flex: 1 } }, /* @__PURE__ */ react.createElement(components_Wrapper, null, /* @__PURE__ */ react.createElement(Flex.Flex, { paddingLeft: 9, paddingRight: 9, paddingTop: 1, justifyContent: "center" }, /* @__PURE__ */ react.createElement(KeyboardNavigable.KeyboardNavigable, { tagName: "button" }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 3, horizontal: true }, relationsType.map((relation) => {
  ...
  }))))), /* @__PURE__ */ react.createElement(InfosWrapper, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Typography.Typography, null, truncate_default()(leftDisplayedValue, { length: 24 }), "\xA0"), /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "primary600" }, formatMessage({ id: (0,getTrad/* default */.Z)(`relation.${relationType}`) }), "\xA0"), /* @__PURE__ */ react.createElement(Typography.Typography, null, truncate_default()(rightDisplayedValue, { length: 24 }))));
};
...
const Relation = ({ formErrors, mainBoxHeader, modifiedData, naturePickerType, onChange }) => {
  ...
  return /* @__PURE__ */ react.createElement(Flex.Flex, { style: { position: "relative" } }, /* @__PURE__ */ react.createElement(
    RelationField,
    {
      isMain: true,
...
const SelectCategory = ({ error, intlLabel, name, onChange, value }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    categories.map((category) => /* @__PURE__ */ react.createElement(Combobox.ComboboxOption, { key: category, value: category }, category))
  );
};
...
const SelectComponent = ({
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    options.map((option) => {
      return /* @__PURE__ */ react.createElement(Select.Option, { key: option.uid, value: option.uid }, `${option.categoryName} - ${option.label}`);
    })
  );
};
...
const SelectDateType = ({ intlLabel, error, modifiedData, name, onChange, options, value }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    options.map(({ metadatas: { intlLabel: intlLabel2, disabled, hidden }, key, value: value2 }) => {
      return /* @__PURE__ */ react.createElement(Select.Option, { key, value: value2, disabled, hidden }, formatMessage(
...
const SelectNumber = ({ intlLabel, error, modifiedData, name, onChange, options, value }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    options.map(({ metadatas: { intlLabel: intlLabel2, disabled, hidden }, key, value: value2 }) => {
      return /* @__PURE__ */ react.createElement(Select.Option, { key, value: value2, disabled, hidden }, formatMessage(intlLabel2));
    })
  );
};
...
const TabForm = ({ form, formErrors, genericInputProps, modifiedData, onChange }) => {
  ...
  return form.map((section, sectionIndex) => {
    ...
    return /* @__PURE__ */ react.createElement(Box.Box, { key: sectionIndex }, section.sectionTitle && /* @__PURE__ */ react.createElement(Box.Box, { paddingBottom: 4 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "h3" }, formatMessage(section.sectionTitle))), /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 4 }, section.items.map((input, i) => {
      ...
      if (input.type === "pushRight") {
        return /* @__PURE__ */ react.createElement(Grid.GridItem, { col: input.size || 6, key: input.name || key }, /* @__PURE__ */ react.createElement("div", null));
      }
      return /* @__PURE__ */ react.createElement(Grid.GridItem, { col: input.size || 6, key: input.name || key }, /* @__PURE__ */ react.createElement(
        build.GenericInput,
...
const FormModal = () => {
  ...
  return /* @__PURE__ */ react.createElement(ModalLayout.ModalLayout, { onClose: handleClosed, labelledBy: "title" }, /* @__PURE__ */ react.createElement(
  ...
  ), !isPickingAttribute && /* @__PURE__ */ react.createElement("form", { onSubmit: handleSubmit }, /* @__PURE__ */ react.createElement(ModalLayout.ModalBody, null, /* @__PURE__ */ react.createElement(
    Tabs.TabGroup,
    {
      label: "todo",
      id: "tabs",
    ...
    /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(
    ...
    ), /* @__PURE__ */ react.createElement(Tabs.Tabs, null, /* @__PURE__ */ react.createElement(Tabs.Tab, { hasError: doesBaseFormHasError }, formatMessage({
    ...
    /* @__PURE__ */ react.createElement(Box.Box, { paddingTop: 6 }, /* @__PURE__ */ react.createElement(Tabs.TabPanels, null, /* @__PURE__ */ react.createElement(Tabs.TabPanel, null, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 6 }, /* @__PURE__ */ react.createElement(
      components_TabForm,
      {
        form: baseForm,
        formErrors,
    ...
    ))), /* @__PURE__ */ react.createElement(Tabs.TabPanel, null, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 6 }, /* @__PURE__ */ react.createElement(
      components_TabForm,
      {
        form: advancedForm,
        formErrors,
    ...
    ModalLayout.ModalFooter,
    {
      ...
      startActions: /* @__PURE__ */ react.createElement(Button.Button, { variant: "tertiary", onClick: handleClosed }, formatMessage({ id: "app.components.Button.cancel", defaultMessage: "Cancel" }))
    }
  )));
};
...
const ContentTypeBuilderNav = () => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(SubNav.SubNavSections, null, menu.map((section) => /* @__PURE__ */ react.createElement(react.Fragment, { key: section.name }, /* @__PURE__ */ react.createElement(
      ...
      section.links.map((link) => {
        if (link.links) {
          return /* @__PURE__ */ react.createElement(SubNav.SubNavLinkSection, { key: link.name, label: upperFirst_default()(link.title) }, link.links.map((subLink) => /* @__PURE__ */ react.createElement(
            SubNav.SubNavLink,
            {
        ...
        return /* @__PURE__ */ react.createElement(SubNav.SubNavLink, { as: react_router_dom_min.NavLink, to: link.to, active: link.active, key: link.name }, upperFirst_default()(formatMessage({ id: link.name, defaultMessage: link.title })));
      })
    ), section.customLink && /* @__PURE__ */ react.createElement(Box.Box, { paddingLeft: 7 }, /* @__PURE__ */ react.createElement(TextButton.TextButton, { onClick: section.customLink.onClick, startIcon: /* @__PURE__ */ react.createElement((Plus_default()), null), marginTop: 2 }, formatMessage({
...
const App = () => {
  ...
  return /* @__PURE__ */ react.createElement(build.CheckPagePermissions, { permissions: permissions/* default.main */.Z.main }, /* @__PURE__ */ react.createElement(Helmet.Helmet, { title }), /* @__PURE__ */ react.createElement(components_FormModalNavigationProvider, null, /* @__PURE__ */ react.createElement(components_DataManagerProvider, { allIcons: icons_namespaceObject }, /* @__PURE__ */ react.createElement(Layout.Layout, { sideNav: /* @__PURE__ */ react.createElement(components_ContentTypeBuilderNav, null) }, /* @__PURE__ */ react.createElement(react.Suspense, { fallback: /* @__PURE__ */ react.createElement(build.LoadingIndicatorPage, null) }, /* @__PURE__ */ react.createElement(react_router_dom_min.Switch, null, /* @__PURE__ */ react.createElement(
